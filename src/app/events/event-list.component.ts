...
@Component({
  ...
  <div class="col-md-12" *ngFor="let event of events">
  <event-thumbnail #thumbnail [event] ="event" (eventClick)="handleClick($event)"></event-thumbnail>
  </div>
  <button class="btn btn-danger btn-sm" (click)="thumbnail.logFoo()" > Log me Some Foo</button>
  `,
...
export class EventComponent implements OnInit {
  ...
  handleClick(data) {
    this.toastr.success('This is toastr test');
